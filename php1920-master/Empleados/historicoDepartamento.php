...
<head>
    ...
    <title>Historico Departamento</title>
    <!--<link rel="stylesheet" href="https://bootswatch.com/4/yeti/bootstrap.min.css"> -->
</head>

<body>
    <h1 class="text-center">Historico Departamento</h1>
        ...
        <div id="App" class="row pt-6">
            <div class="col-md4-">
                <div class="card">
                    ...
                    <form id="product-form" name="" action="historicoDepartamento.php" method="POST" class="card-body">
                        ...
                        <input type="submit" value="Historico Empleados" class="btn btn-outline-info btn-inline">
...
$stmt = $conn->prepare("SELECT empleados.* FROM empleados,emple_depart,departamentos 
								where empleados.dni=emple_depart.dni AND departamentos.cod_dpto=emple_depart.cod_dpto AND departamentos.nombre_dpto='$nombre_dpto' AND emple_depart.fecha_fin IS NOT NULL");
		$stmt->execute();
